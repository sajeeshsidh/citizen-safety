...
interface PoliceAlertDetailsProps {
    alert: Alert;
    isMyActive: boolean;
...
const PoliceAlertDetails: React.FC<PoliceAlertDetailsProps> = ({ alert, isMyActive, isProcessing, onAccept, onResolve, onMapClick }) => {
...
export default PoliceAlertDetails;